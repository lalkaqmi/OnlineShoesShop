...
if(isset($_POST['update_product'])){
   ...
   $product_price = $_POST['product_oldprice'];
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" class="box" name="product_oldprice" value="<?php echo $row ['oldprice']; ?>" placeholder="enter the product oldprice">
